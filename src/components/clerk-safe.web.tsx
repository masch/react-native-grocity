...
// We DON'T import anything from @clerk/expo/native here
// to prevent Metro Web from crashing when analyzing native code.
...
export const UserProfileView = () => (
    <View className="flex-1 justify-center items-center bg-background p-10">
        ...
        <Text className="text-foreground mt-2 text-center text-sm italic">
            El perfil nativo de Clerk solo está disponible en la app móvil real.
        </Text>
    </View>
)
